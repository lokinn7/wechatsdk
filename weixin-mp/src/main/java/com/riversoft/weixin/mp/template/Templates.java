...
public class Templates {
     ...
     * @return 消息ID
     */
    public String send(String toUser, String templateId, String url, Map<String, Data> messages) {
     ...
     * @return
     */
    public String send(String toUser, String templateId, MiniProgram miniProgram, Map<String, Data> messages) {
     ...
     * @return 消息ID
     */
    public String send(String toUser, String templateId, String url, MiniProgram miniProgram, Map<String, Data> messages) {
        ...
        if(result.containsKey("msgid")) {
            return String.valueOf(result.get("msgid"));
        } else {
